...
// ---------------------------------------------------------------------------------
        ...
        */
        ...
        {
            \Wasp\Schema::create('geocodes', function($table) {
                $table->bigIncrements('id');
                $table->decimal('latitude', 10, 5)->index()->default(0);
                $table->decimal('longitude', 10, 5)->index()->default(0);
                $table->string('lng', 2)->index()->default('RU');
                $table->text('address');
                $table->bigInteger('utime')->index()->default(0);
            });
        }
        ...
        * 
        */
        public static function makeUninstall()
        {
            \Wasp\Schema::dropIfExists('geocodes');
        }
