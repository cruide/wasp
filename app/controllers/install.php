...
class Install extends Controller
{
    ...
    public function actionDefault()
    {
        ...
        if( !$schema->hasTable('users_auths') ) {
            $schema->create('users_auths', function( $table ) {
                $table->bigIncrements('id');
                $table->bigInteger('user_id')->index()->default(0);
                $table->string('method', 8)->index()->default( UsersAuth::TYPE_EMAIL );    
        ...
        */
        ...
        $userAuth->method  = UsersAuth::TYPE_EMAIL;
